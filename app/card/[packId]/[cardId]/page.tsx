...
export default function CardPage({
  ...
  // ✅ Background image lives in /public/backgrounds/
  const bgUrl = "/backgrounds/bud-light.jpg";
  ...
  return (
    // ✅ Full-page background image underneath everything
    <div
      style={{
        minHeight: "100dvh",
    ...
    >
      {/* ✅ Soft light panel so all content stays readable */}
      <div
        style={{
          maxWidth: 720,
          margin: "0 auto",
